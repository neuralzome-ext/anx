...
import com.flomobility.anx.databinding.AssetStatusSingleItemBinding
...
class AssetStatusAdapter(
    ...
    private fun observeStatus(
        bind: AssetStatusSingleItemBinding,
