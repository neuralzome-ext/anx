package com.flomobility.anx.hermes.ui.settings
...
//                ActivityOptions.makeSceneTransitionAnimation(context as Activity).toBundle()
    ...
    private var binding: ActivitySettingsAnxBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySettingsAnxBinding.inflate(layoutInflater)
