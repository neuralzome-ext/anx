 ...
 */
public class TerminalDocumentsProvider extends DocumentsProvider {

    private static final String ALL_MIME_TYPES = "*/*";

    private static final File BASE_DIR = TerminalConstants.TERMINAL_HOME_DIR;
    ...
    public Cursor querySearchDocuments(String rootId, String query, String[] projection) throws FileNotFoundException {
        ...
        while (!pending.isEmpty() && result.getCount() < MAX_SEARCH_RESULTS) {
            ...
            try {
                isInsideHome = file.getCanonicalPath().startsWith(TerminalConstants.TERMINAL_HOME_DIR_PATH);
            } catch (IOException e) {
                isInsideHome = true;
            }
            if (isInsideHome) {
