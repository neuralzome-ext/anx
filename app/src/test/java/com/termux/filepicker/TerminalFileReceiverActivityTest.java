...
public class TerminalFileReceiverActivityTest {
    ...
    public void testIsSharedTextAnUrl() {
        ...
        for (String url : validUrls) {
            Assert.assertTrue(TerminalFileReceiverActivity.isSharedTextAnUrl(url));
        }

        List<String> invalidUrls = new ArrayList<>();
        invalidUrls.add("a test with example.com");
        for (String url : invalidUrls) {
            Assert.assertFalse(TerminalFileReceiverActivity.isSharedTextAnUrl(url));
        }
    }
