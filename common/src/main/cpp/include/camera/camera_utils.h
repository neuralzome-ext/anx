...
#ifndef ANX_CAMERA_UTILS_H
#define ANX_CAMERA_UTILS_H
...
#define CALL_CAMERA(func)                                             \
  {                                                                   \
    ...
    ASSERT("CameraUtils", status == ACAMERA_OK, "%s call failed with code: %#x, %s", \
