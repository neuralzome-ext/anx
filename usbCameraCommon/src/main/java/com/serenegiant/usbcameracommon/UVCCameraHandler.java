...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent,  1, width, height, UVCCamera.FRAME_FORMAT_MJPEG, UVCCamera.DEFAULT_BANDWIDTH);
	}

	/**
	 * create UVCCameraHandler, use MediaVideoEncoder, try MJPEG
	 * @param parent
	 * //@param null //cameraView
	 * @param width
	 * @param height
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent, 1, width, height, UVCCamera.FRAME_FORMAT_MJPEG, bandwidthFactor);
	}
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent,  encoderType, width, height, UVCCamera.FRAME_FORMAT_MJPEG, UVCCamera.DEFAULT_BANDWIDTH);
	}
	...
	public static final UVCCameraHandler createHandler(
		...
		return createHandler(parent,  encoderType, width, height, format, UVCCamera.DEFAULT_BANDWIDTH);
	}
	...
	public static final UVCCameraHandler createHandler(
		...
		final CameraThread thread = new CameraThread(UVCCameraHandler.class, parent,  encoderType, width, height, format, bandwidthFactor);
		thread.start();
	...
	@Override
	public void startPreview(  /*final Object surface*/) { super.startPreview(/*surface*/);
	}
