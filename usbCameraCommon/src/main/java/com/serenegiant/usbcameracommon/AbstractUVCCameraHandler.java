...
//			loadShutterSound(parent);
        ...
        public void handleStartPreview(/*final Object surface*/) {
            ...
            try {
                ...
                try {
                    ...
                    if (DEBUG) Log.v(TAG_THREAD, "Fall back to YUV:");
                    mUVCCamera.setPreviewSize(mWidth, mHeight, minFps, maxFps, UVCCamera.DEFAULT_PREVIEW_MODE, mBandwidthFactor);
        ...
        public void handleCaptureStill(final String path) {
            ...
            try {
                final Bitmap bitmap = /*mWeakCameraView.get().captureStillImage()*/ null;
