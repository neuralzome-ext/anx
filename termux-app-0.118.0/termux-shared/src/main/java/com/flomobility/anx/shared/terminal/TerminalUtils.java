...
import com.flomobility.anx.shared.shell.TerminalShellEnvironmentClient;
...
public class TerminalUtils {
    ...
    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMINAL_PACKAGE_NAME} package.
     *
    ...
    public static Context getTermuxPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMINAL_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_API_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxAPIPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_API_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_BOOT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxBootPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_BOOT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_FLOAT_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxFloatPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_FLOAT_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_STYLING_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxStylingPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_STYLING_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_TASKER_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxTaskerPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_TASKER_PACKAGE_NAME);
    }

    /**
     * Get the {@link Context} for {@link TerminalConstants#TERMUX_WIDGET_PACKAGE_NAME} package.
     *
     * @param context The {@link Context} to use to get the {@link Context} of the package.
     * @return Returns the {@link Context}. This will {@code null} if an exception is raised.
     */
    public static Context getTermuxWidgetPackageContext(@NonNull Context context) {
        return PackageUtils.getContextForPackage(context, TerminalConstants.TERMUX_WIDGET_PACKAGE_NAME);
    }
     ...
     * @return Returns {@code errmsg} if {@link TerminalConstants#TERMINAL_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isTerminalAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, TerminalConstants.TERMINAL_APP_NAME, TerminalConstants.TERMINAL_PACKAGE_NAME);
    }
     ...
     *
     * @param context The context for operations.
     * @return Returns {@code errmsg} if {@link TerminalConstants#TERMUX_API_PACKAGE_NAME} is not installed
     * or disabled, otherwise {@code null}.
     */
    public static String isTermuxAPIAppInstalled(@NonNull final Context context) {
        return PackageUtils.isAppInstalled(context, TerminalConstants.TERMUX_API_APP_NAME, TerminalConstants.TERMUX_API_PACKAGE_NAME);
    }
     ...
     * {@link TerminalConstants#TERMINAL_PACKAGE_NAME} and then if
     * {@link TerminalConstants#TERMINAL_PREFIX_DIR_PATH} exists and has
     ...
     *         {@link TerminalConstants#TERMINAL_PREFIX_DIR_PATH} is accessible, otherwise {@code null}.
     */
    public static String isTermuxAppAccessible(@NonNull final Context currentPackageContext) {
        String errmsg = isTerminalAppInstalled(currentPackageContext);
        if (errmsg == null) {
    ...
    /**
     * Send the {@link TerminalConstants#BROADCAST_TERMUX_OPENED} broadcast to notify apps that Termux
     * app has been opened.
     *
     * @param context The Context to send the broadcast.
     */
    public static void sendTerminalOpenedBroadcast(@NonNull Context context) {
        Intent broadcast = new Intent(TerminalConstants.BROADCAST_TERMUX_OPENED);
    ...
    public static String getTermuxPluginAppsInfoMarkdownString(final Context currentPackageContext) {
        ...
        List<String> termuxPluginAppPackageNamesList = TerminalConstants.TERMUX_PLUGIN_APP_PACKAGE_NAMES_LIST;
     ...
     * from the {@link TerminalConstants#TERMINAL_PACKAGE_NAME} package context, then this function
     ...
     * {@link TerminalConstants#TERMINAL_PACKAGE_NAME} package as well if its different from current package.
     * @return Returns the markdown {@link String}.
     */
    ...
    public static String getAppInfoMarkdownStringInner(@NonNull final Context context) {
        ...
        Error error;
        error = TerminalFileUtils.isTermuxFilesDirectoryAccessible(context, true, true);
        if (error != null) {
            AndroidUtils.appendPropertyToMarkdown(markdownString, "TERMUX_FILES_DIR", TerminalConstants.TERMUX_FILES_DIR_PATH);
    ...
    public static String getReportIssueMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("\n\n").append(context.getString(R.string.msg_report_issue, TerminalConstants.TERMUX_WIKI_URL)).append("\n");

        markdownString.append("\n\n### Email\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_SUPPORT_EMAIL_URL, TerminalConstants.TERMUX_SUPPORT_EMAIL_MAILTO_URL)).append("  ");

        markdownString.append("\n\n### Reddit\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_REDDIT_SUBREDDIT, TerminalConstants.TERMUX_REDDIT_SUBREDDIT_URL)).append("  ");

        markdownString.append("\n\n### Github Issues for Termux apps\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMINAL_APP_NAME, TerminalConstants.TERMUX_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_API_APP_NAME, TerminalConstants.TERMUX_API_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_BOOT_APP_NAME, TerminalConstants.TERMUX_BOOT_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_FLOAT_APP_NAME, TerminalConstants.TERMUX_FLOAT_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_STYLING_APP_NAME, TerminalConstants.TERMUX_STYLING_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_TASKER_APP_NAME, TerminalConstants.TERMUX_TASKER_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_WIDGET_APP_NAME, TerminalConstants.TERMUX_WIDGET_GITHUB_ISSUES_REPO_URL)).append("  ");

        markdownString.append("\n\n### Github Issues for Termux packages\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_GAME_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_GAME_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_SCIENCE_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_SCIENCE_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_ROOT_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_ROOT_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_UNSTABLE_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_UNSTABLE_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_X11_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_X11_PACKAGES_GITHUB_ISSUES_REPO_URL)).append("  ");
    ...
    public static String getImportantLinksMarkdownString(@NonNull final Context context) {
        ...
        markdownString.append("\n\n### Github\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMINAL_APP_NAME, TerminalConstants.TERMUX_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_API_APP_NAME, TerminalConstants.TERMUX_API_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_BOOT_APP_NAME, TerminalConstants.TERMUX_BOOT_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_FLOAT_APP_NAME, TerminalConstants.TERMUX_FLOAT_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_STYLING_APP_NAME, TerminalConstants.TERMUX_STYLING_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_TASKER_APP_NAME, TerminalConstants.TERMUX_TASKER_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_WIDGET_APP_NAME, TerminalConstants.TERMUX_WIDGET_GITHUB_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_PACKAGES_GITHUB_REPO_URL)).append("  ");
        ...
        markdownString.append("\n\n### Wiki\n");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_WIKI, TerminalConstants.TERMUX_WIKI_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMINAL_APP_NAME, TerminalConstants.TERMUX_GITHUB_WIKI_REPO_URL)).append("  ");
        markdownString.append("\n").append(MarkdownUtils.getLinkMarkdownString(TerminalConstants.TERMUX_PACKAGES_GITHUB_REPO_NAME, TerminalConstants.TERMUX_PACKAGES_GITHUB_WIKI_REPO_URL)).append("  ");
    ...
    public static String geAPTInfoMarkdownString(@NonNull final Context context) {
        ...
        InputStream inputStream = context.getResources().openRawResource(com.flomobility.anx.shared.R.raw.apt_info_script);
        try {
        ...
        TerminalTask terminalTask = TerminalTask.execute(context, executionCommand, null, new TerminalShellEnvironmentClient(), true);
        if (terminalTask == null || !executionCommand.isSuccessful() || executionCommand.resultData.exitCode != 0) {
        ...
        markdownString.append("## ").append(TerminalConstants.TERMINAL_APP_NAME).append(" APT Info\n\n");
    ...
    public static String getTermuxDebugMarkdownString(@NonNull final Context context) {
        String statInfo = TerminalFileUtils.getTermuxFilesStatMarkdownString(context);
    ...
    public static String getLogcatDumpMarkdownString(@NonNull final Context context) {
        ...
        executionCommand.backgroundCustomLogLevel = Logger.LOG_LEVEL_OFF;
        TerminalTask terminalTask = TerminalTask.execute(context, executionCommand, null, new TerminalShellEnvironmentClient(), true);
        if (terminalTask == null || !executionCommand.isSuccessful()) {
            Logger.logErrorExtended(LOG_TAG, executionCommand.toString());
            return null;
        }
    ...
    public static String getAPKRelease(String signingCertificateSHA256Digest) {
        ...
        switch (signingCertificateSHA256Digest.toUpperCase()) {
            case TerminalConstants.APK_RELEASE_FDROID_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return TerminalConstants.APK_RELEASE_FDROID;
            case TerminalConstants.APK_RELEASE_GITHUB_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return TerminalConstants.APK_RELEASE_GITHUB;
            case TerminalConstants.APK_RELEASE_GOOGLE_PLAYSTORE_SIGNING_CERTIFICATE_SHA256_DIGEST:
                return TerminalConstants.APK_RELEASE_GOOGLE_PLAYSTORE;
            default:
                return "Unknown";
        }
    }
    ...
    /**
     * Get a process id of the main app process of the {@link TerminalConstants#TERMINAL_PACKAGE_NAME}
     * package.
     *
     * @param context The context for operations.
    ...
    public static String getTermuxAppPID(final Context context) {
        return PackageUtils.getPackagePID(context, TerminalConstants.TERMINAL_PACKAGE_NAME);
    }
