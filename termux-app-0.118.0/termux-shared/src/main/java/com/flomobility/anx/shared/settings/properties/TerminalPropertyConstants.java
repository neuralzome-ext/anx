 ...
 * {@link TerminalConstants#TERMUX_PROPERTIES_PRIMARY_FILE_PATH} or
 * {@link TerminalConstants#TERMUX_PROPERTIES_SECONDARY_FILE_PATH}
 */
public final class TerminalPropertyConstants {
    ...
    public static final String DEFAULT_IVALUE_DEFAULT_WORKING_DIRECTORY = TerminalConstants.TERMINAL_HOME_DIR_PATH;
    ...
    public static final Set<String> TERMUX_PROPERTIES_LIST = new HashSet<>(Arrays.asList(
        ...
        TerminalConstants.PROP_ALLOW_EXTERNAL_APPS,
    ...
    public static File getTermuxPropertiesFile() {
        return getPropertiesFile(new String[]{
            TerminalConstants.TERMUX_PROPERTIES_PRIMARY_FILE_PATH,
            TerminalConstants.TERMUX_PROPERTIES_SECONDARY_FILE_PATH
        });
    }

    /** Returns the first {@link File} found at
     * {@link TerminalConstants#TERMUX_FLOAT_PROPERTIES_PRIMARY_FILE_PATH} or
     * {@link TerminalConstants#TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH}
     * from which termux properties can be loaded.
     * If the {@link File} found is not a regular file or is not readable then null is returned.
     *
     * @return Returns the {@link File} object for termux properties.
    ...
    public static File getTermuxFloatPropertiesFile() {
        return getPropertiesFile(new String[]{
            TerminalConstants.TERMUX_FLOAT_PROPERTIES_PRIMARY_FILE_PATH,
            TerminalConstants.TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH
        });
    }
