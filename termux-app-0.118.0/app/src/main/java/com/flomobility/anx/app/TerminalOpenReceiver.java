...
public class TerminalOpenReceiver extends BroadcastReceiver {

    private static final String LOG_TAG = "TerminalOpenReceiver";

    @Override
    public void onReceive(Context context, Intent intent) {
        final Uri data = intent.getData();
        if (data == null) {
            Logger.logError(LOG_TAG, "terminal-open: Called without intent data");
            return;
        }
        ...
        if (isExternalUrl) {
            ...
            try {
                ...
                Logger.logError(LOG_TAG, "terminal-open: No app handles the url " + data);
            }
            return;
        }
        ...
        if (!(fileToShare.isFile() && fileToShare.canRead())) {
            Logger.logError(LOG_TAG, "terminal-open: Not a readable file: '" + fileToShare.getAbsolutePath() + "'");
            return;
        }
        ...
        Uri uriToShare = Uri.parse("content://" + TerminalConstants.TERMUX_FILE_SHARE_URI_AUTHORITY + fileToShare.getAbsolutePath());
    ...
    public static class ContentProvider extends android.content.ContentProvider {
        ...
        private static final String LOG_TAG = "TerminalContentProvider";
        ...
        public ParcelFileDescriptor openFile(@NonNull Uri uri, @NonNull String mode) throws FileNotFoundException {
            ...
            try {
                ...
                if (!(path.startsWith(TerminalConstants.TERMUX_FILES_DIR_PATH) || path.startsWith(storagePath))) {
                ...
                if (TerminalConstants.TERMUX_PROPERTIES_PRIMARY_FILE_PATH.equals(path) ||
                    ...
                    TerminalConstants.TERMUX_FLOAT_PROPERTIES_PRIMARY_FILE_PATH.equals(path) ||
                    TerminalConstants.TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH.equals(path)) {
                    mode = "r";
                }
