...
import com.flomobility.anx.shared.shell.TermuxShellEnvironmentClient;
import com.flomobility.anx.shared.shell.TermuxShellUtils;
    ...
    private synchronized void killAllTermuxExecutionCommands() {
        ...
        for (int i = 0; i < pendingPluginExecutionCommands.size(); i++) {
            ...
            if (!executionCommand.shouldNotProcessResults() && executionCommand.isPluginExecutionCommandWithPendingResult()) {
                if (executionCommand.setStateFailed(Errno.ERRNO_CANCELLED.getCode(), this.getString(com.flomobility.anx.shared.R.string.error_execution_cancelled))) {
