package com.flomobility.anx.app.fragments.settings.terminal_tasker;
...
public class DebuggingPreferencesFragment extends PreferenceFragmentCompat {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.terminal_tasker_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            TerminalTaskerAppSharedPreferences preferences = TerminalTaskerAppSharedPreferences.build(context, true);
