 ...
 *          Terminal app and its plugins. This will allow {@link com.terminal.app.TerminalSettings} to
 ...
 *      - Added following to `TERMINAL_TASKER_APP`:
 *           `KEY_LOG_LEVEL`.
 *
 * - 0.4.0 (2021-03-13)
 *      - Added following to `Terminal_APP`:
 ...
 *
 * - 0.6.0 (2021-03-24)
 *      - Change `DEFAULT_VALUE_KEEP_SCREEN_ON` value to `false` in `TERMINAL_APP`.
 *
 * - 0.7.0 (2021-03-27)
 *      - Added following to `TERMINAL_APP`:
 ...
 *
 * - 0.12.0 (2021-08-27)
 *      - Added `TERMINAL_API_APP.KEY_LOG_LEVEL`, `TERMINAL_BOOT_APP.KEY_LOG_LEVEL`,
 *          `TERMINAL_FLOAT_APP.KEY_LOG_LEVEL`, `TERMINAL_STYLING_APP.KEY_LOG_LEVEL`,
 *          `TERMINAL_Widget_APP.KEY_LOG_LEVEL`.
 *
 * - 0.13.0 (2021-09-02)
 *      - Added following to `TERMINAL_FLOAT_APP`:
 *          `KEY_WINDOW_X`, `KEY_WINDOW_Y`, `KEY_WINDOW_WIDTH`, `KEY_WINDOW_HEIGHT`, `KEY_FONTSIZE`,
 *          `KEY_TERMINAL_VIEW_KEY_LOGGING_ENABLED`.
 *
 * - 0.14.0 (2021-09-04)
 *      - Added `TERMINAL_WIDGET_APP.KEY_TOKEN`.
 *
 * - 0.15.0 (2021-09-05)
 *      - Added following to `TERMINAL_TASKER_APP`:
...
/**
 * A class that defines shared constants of the SharedPreferences used by Terminal app and its plugins.
 ...
 */
public final class TerminalPreferenceConstants {

    /**
     * Terminal app constants.
     */
    public static final class TERMINAL_APP {
        ...
        /**
         * Defines the key for font size of terminal terminal view.
         */
        public static final String KEY_FONTSIZE = "fontsize";


        /**
         * Defines the key for current terminal terminal session.
         */
        ...
        /**
         * Defines the key for whether terminal terminal view key logging is enabled or not
         */
     ...
     */
    public static final class TERMINAL_API_APP {
    ...
    /**
     * Terminal:Boot app constants.
     */
    public static final class TERMINAL_BOOT_APP {
     ...
     */
    public static final class TERMINAL_FLOAT_APP {
     ...
     */
    public static final class TERMINAL_STYLING_APP {
     ...
     */
    public static final class TERMINAL_TASKER_APP {
     ...
     */
    public static final class TERMINAL_WIDGET_APP {
